        ...
        <div className="container mx-auto px-4">
          ...
          >
            <TabsList className="grid w-full grid-cols-3 mb-8">
              <TabsTrigger value="new-arrivals" className="text-xl font-bold">New Arrivals</TabsTrigger>
              <TabsTrigger value="best-sellers" className="text-xl font-bold">Best Sellers</TabsTrigger>
              <TabsTrigger value="on-sale" className="text-xl font-bold">On Sale</TabsTrigger>
            </TabsList>
